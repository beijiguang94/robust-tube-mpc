# Summary
This repository is only for **linear quadratic systems** with **convex constraints** on states/control/bounded disturbance. Besides, if the **dimension** of the system is larger than 3, the calculation of mRPI set becomes quite difficult.
